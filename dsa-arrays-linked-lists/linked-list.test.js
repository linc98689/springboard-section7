...
describe("pivot", function(){
    it("rearrange items in list with vals less than key in the first half, the rest in second hald", function(){
        const lst = new LinkedList([7, 6, 2, 5,3, 5, 9, 1, 1]);
        lst.pivot(5);
        expect(lst).toStrictEqual(new LinkedList([2, 3, 1, 1, 7, 6,5, 5, 9]));

        const lst2 = new LinkedList([7, 6, 5, 9]);
        lst2.pivot(5);
        expect(lst2).toStrictEqual(new LinkedList([7, 6, 5, 9]));
